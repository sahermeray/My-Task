                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route("show-user-profile",\Illuminate\Support\Facades\Auth::user()->id)}}" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route("show-user-products",\Illuminate\Support\Facades\Auth::user()->id)}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>My Products</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route("user-get-add-product-form")}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Product</p>
                                    </a>
                                </li>
