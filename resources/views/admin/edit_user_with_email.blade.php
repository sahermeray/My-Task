...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body" style="text-align: right">
            ...
            @endif
                <form method="POST" action="{{ route('update-user-with-email',$user->id) }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email}}"  autocomplete="phone">
